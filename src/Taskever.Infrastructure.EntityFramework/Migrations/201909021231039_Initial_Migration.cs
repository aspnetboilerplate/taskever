    ...
    public partial class Initial_Migration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpEntityChangeSets", t => t.EntityChangeSetId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpEntityChanges", t => t.EntityChangeId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Friendships", t => t.PairFriendshipId)
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_TaskeverTenant_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.CreatorUserId)
                .ForeignKey("dbo.AbpUsers", t => t.DeleterUserId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Friendships", "UserId", "dbo.AbpUsers");
            DropForeignKey("dbo.Friendships", "PairFriendshipId", "dbo.Friendships");
            DropForeignKey("dbo.Friendships", "FriendUserId", "dbo.AbpUsers");
            ...
            DropIndex("dbo.Friendships", new[] { "PairFriendshipId" });
