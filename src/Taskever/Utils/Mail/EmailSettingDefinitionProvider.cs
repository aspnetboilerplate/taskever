    ...
    public class EmailSettingDefinitionProvider : SettingProvider
    {
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            return new[]
            {
                ...
                new SettingDefinition("Abp.Net.Mail.ServerAddress", "",
                    new LocalizableString("ServerAddress", "Taskever"), isVisibleToClients: true),
                ...
                new SettingDefinition("Abp.Net.Mail.SenderAddress", "",
                    new LocalizableString("SenderAddress", "Taskever"))
            };
        }
    }
}
